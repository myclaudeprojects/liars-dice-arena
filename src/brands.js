...
const SEED_BRANDS = [
  ...
  defineBrand({
    ...
    visualIdentity: {
      ...
      primaryColor: "#8A6A2F",
      secondaryColor: "#3A3834",
      accentColor: "#F3E6C8",
      emblem: "LAUREL_SPEAR",
      materialLanguage: ["bronze", "stone", "leather"],
      backgroundMotif: "IMPERIAL_STONE",
      lightingStyle: "CONTROLLED_KEY",
  ...
  defineBrand({
    ...
    visualIdentity: {
      ...
      primaryColor: "#141416",
      secondaryColor: "#6E6A72",
      accentColor: "#B15CFF",
      emblem: "BROKEN_HOURGLASS",
      materialLanguage: ["smoke", "bone", "spectral energy"],
      backgroundMotif: "ASH_VEIL",
      lightingStyle: "FLICKER_RIM",
  ...
  defineBrand({
    ...
    visualIdentity: {
      ...
      primaryColor: "#163A66",
      secondaryColor: "#D8DEE8",
      accentColor: "#E2B340",
      emblem: "OWL_EYE",
      materialLanguage: ["bronze", "linen", "polished stone"],
      backgroundMotif: "TEMPLE_GEOMETRY",
      lightingStyle: "CLEAR_NORTH",
  ...
  defineBrand({
    ...
    visualIdentity: {
      ...
      accentColor: "#7CFF6A",
      emblem: "SHARK_TOOTH",
      materialLanguage: ["wet stone", "enamel", "dark steel"],
      backgroundMotif: "DEEP_WATER",
      lightingStyle: "HARD_UNDERLIGHT",
  ...
  defineBrand({
    ...
    visualIdentity: {
      ...
      accentColor: "#C9B6F2",
      emblem: "ECLIPSE",
      materialLanguage: ["ink", "glass", "pale metal"],
      backgroundMotif: "NIGHT_DIAL",
      lightingStyle: "SOFT_HALO",
  ...
  defineBrand({
    ...
    visualIdentity: {
      ...
      accentColor: "#F6C453",
      emblem: "FOX_MASK",
      materialLanguage: ["brushed brass", "fur", "lacquer"],
      backgroundMotif: "THICKET",
      lightingStyle: "WARM_SIDE",
  ...
  defineBrand({
    ...
    visualIdentity: {
      ...
      accentColor: "#F0A07A",
      emblem: "DAGGER",
      materialLanguage: ["iron", "leather", "dried clay"],
      backgroundMotif: "SENATE_SHADOW",
      lightingStyle: "HARD_SLASH",
  ...
  defineBrand({
    ...
    visualIdentity: {
      ...
      facialAttitude: "SERENE",
      primaryColor: "#1F4D32",
      secondaryColor: "#E6E1D4",
      accentColor: "#7DAF6A",
      emblem: "STONE_CIRCLE",
      materialLanguage: ["wool", "stone", "ink"],
      backgroundMotif: "CLOISTER",
      lightingStyle: "EVEN_DAY",
  ...
  defineBrand({
    ...
    visualIdentity: {
      ...
      materialLanguage: ["silk", "sea glass", "silver"],
      backgroundMotif: "TIDE_LINE",
      lightingStyle: "COOL_RIM",
  ...
  defineBrand({
    ...
    visualIdentity: {
      ...
      accentColor: "#C5A47E",
      emblem: "LOCKED_COIN",
      materialLanguage: ["tarnished coin", "wool", "iron"],
      backgroundMotif: "COUNTING_HOUSE",
      lightingStyle: "LOW_LAMP",
  ...
  defineBrand({
    ...
    visualIdentity: {
      ...
      accentColor: "#F25CA2",
      emblem: "BROKEN_MASK",
      materialLanguage: ["lacquer", "bell metal", "patchwork"],
      backgroundMotif: "COURT_CURTAIN",
      lightingStyle: "SPLIT_COLOR",
