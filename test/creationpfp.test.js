...
eq(withBrandVersion("/api/show/agents/u_a/pfp.svg", { version: 2 }), "/api/show/agents/u_a/pfp.svg?v=2&s=3", "version query");
eq(withBrandVersion("/api/show/agents/u_a/pfp.svg?size=96", { version: 3 }), "/api/show/agents/u_a/pfp.svg?size=96&v=3&s=3", "version after size");
eq(getAgentPfpUrl({
...
}, 256), "/api/show/agents/u_a/pfp.svg?size=256&v=4&s=3", "sized canonical wins over legacy");
