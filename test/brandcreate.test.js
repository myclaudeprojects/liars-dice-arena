...
(async () => {
  ...
  eq(locked.brand.assets.pfpPortrait, "/api/show/agents/" + a.agent.id + "/pfp.svg?v=1&s=4", "pfp url");
  eq(locked.brand.assets.canonicalPfp, "/api/show/agents/" + a.agent.id + "/pfp.svg?v=1&s=4", "canonical url");
  eq(locked.brand.assets.avatar48, "/api/show/agents/" + a.agent.id + "/pfp.svg?size=48&v=1&s=4", "48 derived");
  eq(locked.brand.assets.avatar96, "/api/show/agents/" + a.agent.id + "/pfp.svg?size=96&v=1&s=4", "96 derived");
